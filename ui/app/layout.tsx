...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  ...
  // inside somebody else's portal is where a viewer has least context about what answered. They
  // are mounted in the LAYOUT rather than in a page because "on every page" is a property of the
  // console, and a page that forgot them would be the one page a screenshot came from.
  return (
    <html lang="en">
