...
export type Health = {
  // What the model pill shows until an answer names a model: where the runtime sits and which
  // model is configured. Both come from the service; nothing in the console infers either.
  runtime: string;
