...
class HealthResponse(BaseModel):
    status: str
    profile: str
    #: Provenance the console's model pill shows until an answer names a model: where the
    #: runtime sits and which model is configured. Derived server-side so the console never
    #: guesses.
