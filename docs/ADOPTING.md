# Adopting Hrz7 as an institutional base

Hrz7 is a reusable case, workflow, and human-review platform. A regulated institution can fork it
...
| Institution integration | `adapters/onprem/`, deployment variables, identity registrations, Hrz3 and Hrz5 bindings, UI branding | Own these files and review them on every upstream release. |
...
2. **Identity and entitlement.** Register IAP or the institutional identity provider, map tenant
   and approver groups through Hrz3, and keep local personas restricted to local loopback demos.
...
7. **Regulatory crosswalk.** Compliance owns the regulator-specific mapping. The appendix
   ...
   review date in your own control register. Rsk1 can provide regulatory knowledge, but this
   repository must not claim a crosswalk the adopter has not approved.
8. **Managed integrations.** Wire Hrz5 as the enterprise WORM and observability owner, Hrz4 as
   promotion authority, and Hrz9 as a journey host where required.
...
- [ ] Registered production identity and Hrz3 entitlement mappings.
...
- [ ] Wired Hrz5 audit and Hrz4 promotion integrations.
